...
use Termwind\Value_Objects\Styles as StylesValueObject;
/**
 * @internal
 */
final class Styles
{
    ...
    {
        self::$storage[$name] = $style = new Style($callback ?? static fn(Styles_Value_Object $styles): \Termwind\Value_Objects\Styles => $styles);
        return $style;
    }
    /**
